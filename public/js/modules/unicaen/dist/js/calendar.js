    ...
    computed: {
        ...
        weekEvents: function weekEvents() {
            ...
            this.events.forEach(function (event) {
                ...
                if (store.inCurrentWeek(event) && (store.filterOwner == '' || store.filterOwner == event.owner_id) && (store.filterType == '' || store.filterType == event.status)) {
...
var ListView = _defineProperty({
    ...
    methods: {
        ...
        handlerTooltip: function handlerTooltip() {

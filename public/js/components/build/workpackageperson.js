...
var Workpackageperson = Vue.extend({
    ...
    methods: {
        ...
        handlerWorkPackagePersonDelete(workpackageperson) {
            this.$http.delete(this.$http.$options.root + "?workpackagepersonid=" + workpackageperson.id).then(res => {
                this.fetch();
            }, err => {
        ...
        handlerWorkPackageDelete(workpackage) {
            this.$http.delete(this.$http.$options.root + "?workpackageid=" + workpackage.id).then(res => {
                this.fetch();
            }, err => {
        ...
        handlerWorkPackageUpdate(workPackageData) {
            ...
            if (workPackageData.id) {
                ...
                this.$http.post(this.$http.$options.root, datas).then(res => {
                    this.fetch();
                }, err => {
                ...
                this.$http.put(this.$http.$options.root, datas).then(res => {
                    this.fetch();
                }, err => {
        ...
        addperson(personid, workpackageid) {
            ...
            this.$http.put(this.$http.$options.root, data).then(res => {
                this.fetch();
            }, err => {
        ...
        fetch() {
            ...
            this.$http.get(this.$http.$options.root).then(res => {

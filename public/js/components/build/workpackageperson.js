        ...
        methods: {
            ...
            fetch: function fetch() {
                ...
                this.$http.get(this.$http.$options.root).then(function (res) {
                    ...
                    _this9.isDeclarant = false; // res.body.isDeclarant;
                    _this9.isValidateur = false; // res.body.isValidateur;
                }, function (err) {

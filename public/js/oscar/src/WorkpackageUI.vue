...
<script>
// poi watch --format umd --moduleName  WorkpackageUI --filename.css WorkpackageUI.css --filename.js WorkpackageUI.js --dist public/js/oscar/dist public/js/oscar/src/WorkpackageUI.vue
export default {
    components: {
        'workpackage': require('./Workpackage.vue').default
    },

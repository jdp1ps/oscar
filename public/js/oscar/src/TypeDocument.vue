...
<script>
    // poi watch --format umd --moduleName  TypeDocument --filename.css TypeDocument.css --filename.js TypeDocument.js --dist public/js/oscar/dist public/js/oscar/src/TypeDocument.vue
    export default {
        props: {
            url: { required: true },
            manage: false,

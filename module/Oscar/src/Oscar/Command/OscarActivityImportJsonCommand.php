...
class OscarActivityImportJsonCommand extends OscarCommandAbstract
{
    ...
    protected function configure()
    {
        ...
        $this->addOption('create-missing-project', 'p', InputOption::VALUE_OPTIONAL,
            "Créer automatiquement les projets manquants",false);
//
        $this->addOption('create-missing-person', 'e', InputOption::VALUE_OPTIONAL,
            "Créer automatiquement les personnes manquantes",false);

        $this->addOption('create-missing-person-role', 'r', InputOption::VALUE_OPTIONAL,
            "Créer automatiquement les rôles des personnes manquants",false);

        $this->addOption('create-missing-organization', 'o', InputOption::VALUE_OPTIONAL,
            "Créer automatiquement les organisations manquantes",false);

        $this->addOption('create-missing-organization-role', 'l', InputOption::VALUE_OPTIONAL,
            "Créer automatiquement les rôles des organisations manquants",false);

...
class OscarPersonsSyncJsonCommand extends OscarCommandAbstract
{
    protected static $defaultName = 'persons:sync-json';

    protected function configure()
    {
        $this
            ->setDescription("Execute la synchronisation des personnes depuis une source JSON")
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $io->title("Synchronisation des personnes (JSON)");

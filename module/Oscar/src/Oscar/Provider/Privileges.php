...
class Privileges extends \UnicaenPrivilege\Provider\Privilege\Privileges
{
    ...
    const ACTIVITY_EDIT_LOCKED = 'ACTIVITY-EDIT_LOCKED';
    const ACTIVITY_ORGANIZATION_MANAGE = 'ACTIVITY-ORGANIZATION_MANAGE';

    const ACTIVITY_PCRU = 'ACTIVITY-PCRU';
    const ACTIVITY_PCRU_ACTIVATE = 'ACTIVITY-PCRU_ACTIVATE';

    const ACTIVITY_CONTRACT_SHOW = 'ACTIVITY-CONTRACT_SHOW';
    const ACTIVITY_CONTRACT_SEND = 'ACTIVITY-CONTRACT_SEND';
    ...
    const ACTIVITY_REQUEST_ADMIN = 'ACTIVITY-REQUEST_ADMIN';
    ...
    const ACTIVITY_ESTIMATEDSPENT_SHOW = 'ACTIVITY-ESTIMATEDSPENT_SHOW';
    const ACTIVITY_ESTIMATEDSPENT_MANAGE = 'ACTIVITY-ESTIMATEDSPENT_MANAGE';
    ...
    const ACTIVITY_DOCUMENT_DELETEDSIGNED = 'ACTIVITY-DOCUMENT_DELETEDSIGNED';
    ...
    const ACTIVITY_TIMESHEET_VALIDATE_ACTIVITY = 'ACTIVITY-TIMESHEET_VALIDATE_ACTIVITY';
    const ACTIVITY_TIMESHEET_USURPATION = 'ACTIVITY-TIMESHEET_USURPATION';
    const ACTIVITY_TIMESHEET_VIEW = 'ACTIVITY-TIMESHEET_VIEW';

    const ACTIVITY_NOTES_SHOW = 'ACTIVITY-NOTES_SHOW';
    const ACTIVITY_NOTES_MANAGE_USER = 'ACTIVITY-NOTES_MANAGE_USER';
    const ACTIVITY_NOTES_MANAGE_ADMIN = 'ACTIVITY-NOTES_MANAGE_ADMIN';

    const ACTIVITY_AVENANTS_SHOW = 'ACTIVITY-AVENANTS_SHOW';
    const ACTIVITY_AVENANTS_MANAGE = 'ACTIVITY-AVENANTS_MANAGE';

    const MAINTENANCE_ACTIVITYTYPE_MANAGE = 'MAINTENANCE-ACTIVITYTYPE_MANAGE';
    const MAINTENANCE_MILESTONETYPE_MANAGE = 'MAINTENANCE-MILESTONETYPE_MANAGE';
    const MAINTENANCE_TVA_MANAGE = 'MAINTENANCE-TVA_MANAGE';
    const MAINTENANCE_DOCUMENTTYPE_MANAGE = 'MAINTENANCE-DOCUMENTTYPE_MANAGE';
    const MAINTENANCE_NUMEROTATION_MANAGE = 'MAINTENANCE-NUMEROTATION_MANAGE';
    const MAINTENANCE_DOCPUBSEC_MANAGE = 'MAINTENANCE-DOCPUBSEC_MANAGE';
    const MAINTENANCE_SIGNATURE_DELETE = 'MAINTENANCE-SIGNATURE_DELETE';
    ...
    const PERSON_SHOW_SCHEDULE      = 'PERSON-SHOW_SCHEDULE';
    const PERSON_MANAGE_SCHEDULE    = 'PERSON-MANAGE_SCHEDULE';
    const PERSON_SYNC_LDAP = 'PERSON-SYNC_LDAP';
    const PERSON_PROJECTS = 'PERSON-PROJECTS';
    const PERSON_INFOS_RH = 'PERSON-INFOS_RH';
    const PERSON_INFOS_TECH = 'PERSON-INFOS_TECH';
    ...
    const PERSON_FEED_TIMESHEET = 'PERSON-FEED_TIMESHEET';

    const ORGANIZATION_SHOW = 'ORGANIZATION-SHOW';
    const ORGANIZATION_EDIT = 'ORGANIZATION-EDIT';
    const ORGANIZATION_DELETE = 'ORGANIZATION-DELETE';
    ...
    const MAINTENANCE_ORGANIZATIONTYPE_MANAGE = 'MAINTENANCE-ORGANIZATIONTYPE_MANAGE';
    const MAINTENANCE_DISCIPLINE_MANAGE = 'MAINTENANCE-DISCIPLINE_MANAGE';
    const MAINTENANCE_VALIDATION_MANAGE = 'MAINTENANCE-VALIDATION_MANAGE';
    const MAINTENANCE_SPENDTYPEGROUP_MANAGE = 'MAINTENANCE-SPENDTYPEGROUP_MANAGE';
    const MAINTENANCE_PARAMETERS_MANAGE = 'MAINTENANCE-PARAMETERS_MANAGE';
    const MAINTENANCE_PCRU_LIST = 'MAINTENANCE-PCRU_LIST';
    const MAINTENANCE_PCRU_UPLOAD = 'MAINTENANCE-PCRU_UPLOAD';

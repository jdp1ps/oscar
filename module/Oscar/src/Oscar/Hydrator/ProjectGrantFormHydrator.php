...
class ProjectGrantFormHydrator implements HydratorInterface, UseServiceContainer
{
    ...
    public function hydrate(array $data, $object)
    {
        ...
        $object
            ...
            ->setFraisDeGestionPartGestionnaire($this->decimalOrPercent($data['fraisDeGestionPartGestionnaire']))
    ...
    public function extract( object $object ): array
    {
        return [
            ...
            'fraisDeGestionPartGestionnaire' => $object->getFraisDeGestionPartGestionnaire(),

...
Pour activer l'affichage des dépenses, vous devez : 
 - Configurer les masses
 - Configurer le plan comptable par défaut.
 - Accorder le privilège **Voir les dépenses**

### Configurer les masses

Par défault, les passes configurées sont : 
 - **F** : Fonctionnement
 - **I** : Inverstissement
 - **P** : personnel

      ...
      <div class="overlay-content">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <article class="timesheet-item horslots-item" v-for="w in others" @click.prevent="handlerSelectOther(w)"
                     :class="{ 'selected' : selection == w, 'disabled': !w.validation_up }">
        ...
        <nav>
          ...
          <button class="btn btn-primary" v-if="usevalidation" :class="selection ? '' : 'disabled'"
                  @click="handlerValidSelection()">Valider
          </button>
        </nav>
      </div>
